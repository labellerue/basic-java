...
public class Exam08 {
		...
		답: 
		프로그램 실행 시 어떠한 이유로 나타나는 오류를 대비해 만드는 코드
		예외의 경우에도 프로그램이 문제 없이 돌아가도록 하기 위함.
		...
		부모클래스의 예외처리 범위 내에서만 오버라이딩이 가능하다.
		...
		최고 조상을 catch로 받았다면 더이상 다른 예외가 없다
		...
		* 메서드 :
		...
		class UnsupportedFuctionException extends RuntimeException{
			...
			UnsupportedFuctionException(String err, int err_code){
